...
# Get Beta distribution parameters for the probabilities, use those to resample for the proportion of K each stock is getting.
beta.params <- NULL
for(ss in stock.eco)
{
  #browser()
...
save(sim.quantiles = quants,
     ...
     ,file = paste0(repo.loc,"/Results/BU/All_results_",n.sims,"_sims_",min(years),"_to_",max(years),
